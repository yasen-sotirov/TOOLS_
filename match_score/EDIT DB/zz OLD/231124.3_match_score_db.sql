...
CREATE TABLE IF NOT EXISTS `match_score_db`.`tournaments` (
  ...
  `number_participants` INT(11) NOT NULL DEFAULT 4,
  `format` VARCHAR(45) NOT NULL,
  `date` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `match_score_db`.`tournament_teams`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `match_score_db`.`tournament_teams` (
  `teams_id` INT(11) NOT NULL,
  `team_name` VARCHAR(45) NULL DEFAULT NULL,
  `tournaments_id` INT(11) NOT NULL,
  `tournament_title` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `match_score_db`.`tournaments_players` (
  ...
  `tournaments_id` INT(11) NOT NULL,
  `tournament_title` VARCHAR(45) NULL DEFAULT NULL,
  INDEX `fk_tournaments_participants_players1_idx` (`players_id` ASC) VISIBLE,
  INDEX `fk_tournaments_participants_tournaments1_idx` (`tournaments_id` ASC) VISIBLE,
  CONSTRAINT `fk_tournaments_participants_players1`
    FOREIGN KEY (`players_id`)
    REFERENCES `match_score_db`.`players` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tournaments_participants_tournaments1`
    FOREIGN KEY (`tournaments_id`)
    REFERENCES `match_score_db`.`tournaments` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
