...
"""
Вместо класовете да създават обектите от които зависят, те се 
предоставят на класа по време на инстанциране, обикновено чрез конструктора
...
DEPENDENCY - обект, който е необходим за да работи един клас
Injection - обектът се включва в класа през конструктора или сетъра,
    а не чрез направата на нова инстанция
...
- За да работи един клас има нужда от друг клас
