...
Application Program Interface - web сървис, който ни дава интерфейс към приложенията 
...
RESTFULL конвенции - ot prezentaci[ta

POST / createUser           POST /user
PUT /updateUser/:id         PUT /user/:id
