...
- по-лесен за работа и писане

ползва се при:
- при нужда от функции    -   
- при работа с .json


MAPS
- по-добър performance
- ключовете могат да бъдат всякакъв тип
- лесен за итериране
- лесен за изчисляване на размера

ползва се при:
- при нужда от проста двойка key-value
- при нужда ключовете да не са стрингове
