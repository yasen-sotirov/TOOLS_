...
function createNote() {
  ...
  node1.setAttribute("style", "width:250px; height:250px; font-size:26px; padding:25px; margin-top:10px; overflow:hidden; box-shadow:0px 10px 24px 0px rgb(0, 0, 0, 0.75)");
...
function rotate() {
  const random_rotate = ["rotate(3deg)", "rotate(1deg)", "rotate(-1deg)", 
  "rotate(-3deg)", "rotate(-5deg)", "rotate(-10deg)"];
  return random_rotate[Math.floor(Math.random() * random_rotate.length)];
};

function color() {
  const random_color = ["#c2ff3d", "#ff3de8", "#3dc2ff", "#04e022", 
