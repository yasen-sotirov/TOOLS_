""""
You will be receiving names of models, their ID, and a course of programming they
...
of the models who have taken the corresponding course in the format: "{name} - {ID}"
on separate lines.
"""
